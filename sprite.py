...
# 画像ファイルパス
GIRL1_IMG_PATH = r"E:\tuto\main.png"
GIRL2_IMG_PATH = r"E:\tuto\dot1.png"
GIRL3_IMG_PATH = r"E:\tuto\dot2.png"
GIRL4_IMG_PATH = r"E:\tuto\dot3.png"
GIRL5_IMG_PATH = r"E:\tuto\dot4.png"

# 背景の画像ファイルパス
BACKGROUND_IMG_PATH = r"E:\tuto\background.jpg"

# スプライトのクラス
class Girl(pygame.sprite.Sprite):
    # スプライトの初期化(画像ファイル名, 位置pos(x, y), 速さvxy(vx, vy), 回転angle)
    def __init__(self, filepath, pos, vxy, angle=0, scale=None):
...
def main():
    ...
    girl2 = Girl(GIRL2_IMG_PATH,(200, 200), (0, 2), -20, scale=(120, 120))
